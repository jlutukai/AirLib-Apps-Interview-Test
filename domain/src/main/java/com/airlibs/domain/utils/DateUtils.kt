...
object DateUtils {
    ...
    fun String.shortDateToUnixTimeStampCurrentTime(): Long {
        return try {
            val outFormat = SimpleDateFormat(
                "yyyy-MM-dd",
                Locale.getDefault()
            )
            val time = outFormat.parse(this)?.time ?: 0
    ...
    fun String.shortDateToUnixTimeStampStartTime(): Long {
        return try {
            val outFormat = SimpleDateFormat(
                "yyyy-MM-dd",
                Locale.getDefault()
    ...
    fun String.shortDateToUnixTimeStampEndTime(): Long {
        return try {
            val outFormat = SimpleDateFormat(
                "yyyy-MM-dd",
                Locale.getDefault()
